...
//  virtualtourist
//
//  Created by OLIVER HAGER on 9/23/15.
...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    /// map region last displayed in map view
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        if let mapRegion = LocationRepository.getMapRegion() {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.webporting.virtualtourist" in the application's documents Application Support directory.
